...
PATTERNS = [
    ...
    (r"lag_params%packing_flag", "Euler-Lagrange particle packing mode (0=file input, 1=box, 2=hemisphere shell)"),
    (r"lag_params%packing_size_distribution", "Packed particle size distribution (0=constant, 1=uniform, 2=Gaussian)"),
    (r"lag_params%packing_seed", "Random seed for deterministic Euler-Lagrange particle packing"),
    (r"lag_params%packing_volume_fraction", "Target Euler-Lagrange particle packing volume fraction"),
    (r"lag_params%packing_diameter_min", "Minimum diameter for packed Euler-Lagrange particles"),
    (r"lag_params%packing_diameter_max", "Maximum diameter for packed Euler-Lagrange particles"),
    (r"lag_params%packing_diameter_mean", "Mean or constant diameter for packed Euler-Lagrange particles"),
    (r"lag_params%packing_diameter_std", "Gaussian diameter standard deviation for packed Euler-Lagrange particles"),
    (r"lag_params%packing_min_spacing", "Minimum surface-to-surface spacing for packed Euler-Lagrange particles"),
    (r"lag_params%packing_centroid\((\d+)\)", "Centroid component {0} for Euler-Lagrange particle packing"),
    (r"lag_params%packing_length\((\d+)\)", "Box length component {0} for Euler-Lagrange particle packing"),
    (r"lag_params%packing_velocity\((\d+)\)", "Initial velocity component {0} for packed Euler-Lagrange particles"),
    (r"lag_params%packing_shell_inner_radius", "Inner radius for Euler-Lagrange shell packing"),
    (r"lag_params%packing_shell_outer_radius", "Outer radius for Euler-Lagrange shell packing; shell packing uses this to set the hash box length automatically"),
